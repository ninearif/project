...
<?php endif ?>        
  ...
  <div class="copyright">
	 <a href="http://qdpm.net" target="_blank">qdPM (edited) <?php echo sfConfig::get('app_qdpm_version') ?></a> <br> Copyright &copy; <?php echo  date('Y') ?> <a href="http://qdpm.net" target="_blank">qdpm.net</a>
  </div>
